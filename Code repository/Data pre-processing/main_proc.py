...
fpath = "C:/Users/14233242/Documents/Python Scripts/repo_codes"  #folder path where gaze data and ground truth are stored

### Load ground truth data####
with open('C:/Users/14233242/Documents/Python Scripts/repo_codes/ground_truth_data.csv','r') as csvfile:
...
for file in os.listdir(fpath):
    ...
    f_name_c = os.path.join("C:/Users/14233242/Documents/Python Scripts/repo_codes/",str1+ "_c_"+ str2)
    f_name_r = os.path.join("C:/Users/14233242/Documents/Python Scripts/repo_codes/",str1+ "_r_"+ str2)
    f_name_l = os.path.join("C:/Users/14233242/Documents/Python Scripts/repo_codes/",str1+ "_l_"+ str2)
